        ...
        <h1>静态图对比<span class="tips">提示：可以按住"ctrl"和"+"键放大对比;可以在右边选择背景颜色</h1>
            <?php
                ...
                for($i=1;$i<16;$i++){
                    ...
                    $webpimg="image/jingtai/webp/".$i.".webp";
                    $pngimg="image/jingtai/png/".$i.".png";
            ...
            <div class="imgcont clearfix" id="imgcont1">
                ...
                <div class="img">
                    <img src="<?php echo $webpimg; ?>"/>
                    <p>大小：<strong><?php echo round(intval(filesize($webpimg))/1024, 2) ?></strong>k</p>
                </div>
